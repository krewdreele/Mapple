...
{
    const string privateCode = "JivL6SlfbEW_Zl1AmIM0KgOiTDJuxobE2nMgLyGbmjxw";  //Key to Upload New Info
    const string publicCode = "641b63f58f40bb109cee04b6";   //Key to download
